...
class Zone23: BaseScene {
    ...
    override func didMove(to view: SKView) {
        ...
        // 選手B
        playerB0.position = CGPoint(x: SKVIEW_WIDTH*0.35, y: ZONE_FRONT_HEIGHT!)
        ...
        playerB1.position = CGPoint(x: SKVIEW_WIDTH*0.65, y: ZONE_FRONT_HEIGHT!)
        ...
        playerB2.position = CGPoint(x: SKVIEW_WIDTH*0.25, y: ZONE_BACK_HEIGHT!)
        ...
        playerB3.position = CGPoint(x: SKVIEW_WIDTH*0.5, y: ZONE_BACK_HEIGHT!)
        ...
        playerB4.position = CGPoint(x: SKVIEW_WIDTH*0.75, y: ZONE_BACK_HEIGHT!)
